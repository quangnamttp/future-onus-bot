...
async function fetchMarketCaps() {
  ...
  return {
    BTC: data.BTC.quote.USD.market_cap.toLocaleString(),
    ETH: data.ETH.quote.USD.market_cap.toLocaleString(),
    SOL: data.SOL.quote.USD.market_cap.toLocaleString()
  };
}
